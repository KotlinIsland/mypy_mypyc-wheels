...
Unfortunately, these options may not work, and could isntead install a source dist or the wrong version.
In this case you will need to manually select the wheel you wish to install:
```bash
